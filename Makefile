...
LOCAL_MIGRATION_DSN="host=localhost port=54321 dbname=note-service user=note-service-user password=note-password sslmode=disable"
...
generate:
	...
	mv pkg/note_v1/github.com/almira-galeeva/note-service-api/pkg/note_v1/* pkg/note_v1
